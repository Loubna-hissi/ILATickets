...
//Nombre Etudiants
$sql1="SELECT COUNT(ID_COMPTE) AS 'totalEtudiant' FROM 'compte'";
$etudiant= $connexion->prepare($sql1);
$etudiant->execute();
//Nombre Tickets
$sql2="SELECT COUNT(ID_TICKET) AS 'totalTicket' FROM 'ticket' WHERE STATUT_PAIMENT='1'";
$ticket= $connexion->prepare($sql2);
$ticket->execute();
//Nombre Admins
$sql3="SELECT COUNT(CIN_RESPONSABLE) AS 'totalAdmin' FROM 'responsable'";
$admin= $connexion->prepare($sql3);
$admin->execute();
print_r($admin->fetchColumn()); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <div class="card-body bg-success text-white">
            <div class="row">
              ...
              <div class="col-9 text-right">
                <h1><?php echo print_r($admin->fetchColumn()); ?></h1>
                <h4>Admin</h4>
              </div>
            </div>
          </div>
        ...
        <div class="card border-secondary">
          <div class="card-body bg-secondary text-white">
            <div class="row">
              ...
              <div class="col-9 text-right">
                <h1><?php echo print_r($etudiant->fetchColumn()); ?></h1>
          ...
          <div class="card-body bg-danger text-white">
            <div class="row">
              ...
              <div class="col-9 text-right" style="padding-left: 50px;">
                <h1><?php echo print_r($ticket->fetchColumn()); ?></h1>
